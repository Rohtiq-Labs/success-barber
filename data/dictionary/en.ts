export const en = {
  ...
  hero: {
    ...
    scroll: "Scroll",
    imageAlt:
      "Success Barbershop interior — barbers at work in Dubai Marina",
  },
  ticker: [
    "Precision Fades",
    "Latin Energy",
  ...
  experience: {
    ...
    pillars: [
      ...
      },
      {
        ...
        desc: "Designed as a destination. The space itself communicates that you are somewhere rare — a boutique experience in the heart of Dubai Marina.",
      },
    ],
  },
  services: {
  ...
  space: {
    headline: "The",
    headlineBreak: "Space",
    desc: "Designed as a destination. Wharf Tower 1, Dubai Marina — a location as refined as the experience within.",
    panels: [
      { caption: "The Studio — Dubai Marina", alt: "Success Barbershop studio — four private chairs, Dubai Marina" },
    ...
    attributes: [
      { label: "Location", value: ["Dubai Marina", "Wharf Tower 1"] },
      { label: "Atmosphere", value: ["Boutique", "Minimal"] },
      { label: "Stations", value: ["4 Private", "Chairs"] },
      { label: "Open Daily", value: ["9:00 — 21:00"] },
    ],
  },
  visit: {
    label: "Visit Us",
    ...
    contact: {
      label: "Contact",
      phone: "+971 52 873 7000",
    },
    ctas: [
      { label: "WhatsApp", text: "Book via WhatsApp", href: "https://wa.me/971528737000", external: true },
      { label: "Phone", text: "Call the Studio", href: "tel:+971528737000", external: false },
      {
        label: "Directions",
        text: "Get Directions",
